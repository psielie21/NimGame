...
/**
 * The Nim logic class provides the model for the nim game. It can handle all
 * the input from the user and provides the necessary functionalities that need
 * to be displayed.
 */
public class NimLogic {
     ...
     * 
     * @param sticks      An array of positive integers representing the sticks
     *                    per row.
    ...
    /**
     * Removes a certain amount of sticks from the specified row.
     * 
     ...
     * 
     * @return A boolean value that is true if the game is over and false if the
